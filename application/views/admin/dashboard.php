                ...
                <div class="boxx">
                    <div class="box1" style="border-radius: 10px;">
                        <div class="title" style="padding: 10px;">
                            ...
                            <h2 class="int"><strong><?php echo $set_siswa; ?></strong></h2>
                        </div>
                    </div>
                    <div class="box2" style="border-radius: 10px;">
                        <div class="title" style="padding: 10px;">
                            <h3>Data Jumlah Ekskul</h2>
							<h2 class="int"><strong><?php echo $set_ekskul; ?></strong></h2>
                        </div>
                    </div>
                </div>
                <p></p>
